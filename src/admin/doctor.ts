...
// --- תשובות מחוץ לחלון 24 השעות ---
if (!env("META_REPLY_TEMPLATE")) {
  add(
    "warn",
    "מענה אנושי",
    "לא הוגדרה תבנית תשובה (META_REPLY_TEMPLATE). תשובה להורה שכתב לפני יותר מ-24 שעות תיכשל. " +
      "אם המענה האנושי אינו יומי, זה יקרה הרבה. ראו README.",
  );
} else {
  add("ok", "מענה אנושי", "תבנית תשובה מוגדרת — אפשר לענות גם מחוץ לחלון 24 השעות.");
}
