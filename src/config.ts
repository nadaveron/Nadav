...
export const config = {
  ...
  handoff: {
    ...
    message: opt(
      "HANDOFF_MESSAGE",
      "רשמתי את הפנייה והעברתי אותה לטיפול. " +
        "המענה האנושי כאן אינו מיידי ועשוי לקחת כמה ימים, אז אם העניין דחוף - " +
        "כדאי לפנות ישירות לגוף המפעיל של החוג, ואשמח למסור לך את מספר הטלפון שלו. " +
